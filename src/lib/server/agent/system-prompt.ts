...
export const ARTIFACT_INSTRUCTIONS = [
  ...
  "html may be a fragment or a full document; svg is the bare <svg>; jsx, tsx and svelte must",
  "default-export one component. Importable: react, react-dom/client, react/jsx-runtime, svelte —",
  "nothing else. Tailwind-style utility classes work (UnoCSS).",
